...
def main():
    ...
    # ngpus_per_node processes per node and ngpus_per_node gpus per node
    # that is, 1 process for each gpu on each node. world_size is the total
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # check if it ever enter the else branch ???
    else:
        print("flag 2")
        model.cuda()
